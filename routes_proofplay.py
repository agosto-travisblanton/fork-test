...
application = WSGIApplication(
        [
            ...
            Route(
                    r'/proofplay/api/v1/one_resource_by_date/<start_date>/<end_date>/<resource>',
                    handler="proofplay.main.OneResourceByDate",
                    name="OneResourceByDate"
            ),
            Route(
                    r'/proofplay/api/v1/multi_resource_by_date/<start_date>/<end_date>/<resources>',
                    handler="proofplay.main.MultiResourceByDate",
                    name="MultiResourceByDate"
            ),
            Route(
                    r'/proofplay/api/v1/one_resource_by_device/<start_date>/<end_date>/<resource>',
