...
class TestDeviceResourceHandler(BaseTest, WebTest):
    ...
    # def test_device_resource_handler_post_returns_created_with_registered_device_in_provisioning(self):
    ...
    #                     'gcmRegistrationId': '8d70a8d78a6dfa6df76dfasd',
    #                     'tenantCode': 'Acme'}
    ...
    def test_device_resource_handler_post_returns_created_with_registered_device_not_in_provisioning(self):
        chrome_os_device = ChromeOsDevice(device_id='4f099e50-6028-422b-85d2-3a629a45bf38',
                                          gcm_registration_id='0d70a8d78a6dfa6df76dfasd',
                                          tenant_code='acme')
        chrome_os_device.put()
        request_body = {'macAddress': '54271e619346',
                        'gcmRegistrationId': '123',
