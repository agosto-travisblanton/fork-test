...
from workflow.get_impersonation_email_from_device_key import get_impersonation_email_from_device_key


class TestGetImpersonationEmailFromDeviceKey(BaseTest):
    ...
    def setUp(self):
        super(TestGetImpersonationEmailFromDeviceKey, self).setUp()
