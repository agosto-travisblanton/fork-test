...
def interrogate_chrome_os_device_by_mac_address(device_mac_address, impersonation_email, page_token=None):
        ...
        if chrome_os_device is not None:
            ...
            if new_page_token is not None:
                interrogate_chrome_os_device_by_mac_address(
                    ...
                    impersonation_admin_email_address=impersonation_email,
