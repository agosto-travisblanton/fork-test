(function () {
  ...
  angular.module(t).directive("mdcDatetimePickerCalendar", [function () {
    var t = e(), a = 1900, i = 2100, r = (i - a + 1) * 12, n = 240, s = [];
    for (var c = 0; c < r; c++) {
      s.push(c)
    }
    var l = function (e) {
      ...
      controller: ["$scope", function (t) {
        ...
        var m = function (t) {
          ...
          if (t !== null) {
            ...
            var u = 7, d = [], m = Math.ceil(a.days.length / u);
            for (var p = 0; p < m; p++) {
  ...
  angular.module(t).directive("mdcDatetimePickerClock", [function () {
    ...
    return {
      restrict: "E", template: e, link: function (e, t, a) {
        var r = a.mode === "minutes";
        var n = e.picker;
        var s = document.querySelector("md-dialog.dtp");
        var c = function () {
          var a = angular.element(t[0].querySelector(".dtp-picker-clock")), c = angular.element(s.querySelector(".dtp-picker"));
          ...
          for (var b = 0; b < 12; ++b) {
            ...
            var T = {left: M + A + v / 2 - (v + g), top: M - I - k / 2 - (D + k), value: r ? b * 5 : b};
            if (r) {
          ...
          var S = w.offsetWidth / 2 || 7.5, Y = w.offsetHeight / 2 || 7.5;
          var H = M / 1.8;
          var V = M / 1.5;
          ...
          angular.element(w).css({left: M + v + g - S + "px", marginTop: M - g / 2 - Y + "px"});
          l()
        };
        var l = function () {
        ...
        var o = function (e, t) {
          angular.element(e).css({WebkitTransform: "rotate(" + t + "deg)", "-moz-transform": "rotate(" + t + "deg)"})
        };
        var u = function () {
