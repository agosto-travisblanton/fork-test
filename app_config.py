...
class AppConfig(Config):
    ...
    INTEGRATION_EVENTS_DEFAULT_EVENTS_CATEGORY = None
    INTEGRATION_EVENTS_DEFAULT_COMPONENT_NAME = None
    INTEGRATION_EVENTS_DEFAULT_FETCH_SIZE = None
    INTEGRATION_EVENTS_REGISTRATION_WORKFLOW_STEP_1 = None
    INTEGRATION_EVENTS_REGISTRATION_WORKFLOW_STEP_2 = None
    INTEGRATION_EVENTS_REGISTRATION_WORKFLOW_STEP_3 = None
    INTEGRATION_EVENTS_REGISTRATION_WORKFLOW_STEP_4 = None
    INTEGRATION_EVENTS_REGISTRATION_WORKFLOW_STEP_5 = None
    INTEGRATION_EVENTS_REGISTRATION_WORKFLOW_STEP_6 = None
