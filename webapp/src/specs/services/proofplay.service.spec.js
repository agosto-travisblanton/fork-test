...
describe('ProofPlayService', function () {
  ...
  describe('querying for csvs', function () {
    ...
    it('sets tenant and downloads multi-resource csv across date range', function () {
      ...
      return expect(window.open).toHaveBeenCalledWith(`http://localhost:9876/proofplay/api/v1/multi_resource_by_date/${start_date}/${end_date}/${allResources}/${tenants[0]}/${cookie_token}`, '_blank');
    });
    ...
    it('sets tenant and downloadCSVForMultipleResourcesByDevice', function () {
      ...
      return expect(window.open).toHaveBeenCalledWith(`http://localhost:9876/proofplay/api/v1/multi_resource_by_device/${start_date}/${end_date}/${allResources}/${tenants[0]}/${cookie_token}`, '_blank');
    });
    ...
    it('sets tenant and downloads multi-devices summarized csv', function () {
      ...
      return expect(window.open).toHaveBeenCalledWith(`http://localhost:9876/proofplay/api/v1/multi_device_summarized/${start_date}/${end_date}/${allDevices}/${tenants[0]}/${cookie_token}`, '_blank');
    });
    ...
    it('sets tenant and downloadCSVForMultipleDevicesByDate', function () {
      ...
      return expect(window.open).toHaveBeenCalledWith(`http://localhost:9876/proofplay/api/v1/multi_device_by_date/${start_date}/${end_date}/${allDevices}/${tenants[0]}/${cookie_token}`, '_blank');
    });
    ...
    it('sets tenant and downloadCSVForMultipleLocationsByDevice', function () {
      ...
      return expect(window.open).toHaveBeenCalledWith(`http://localhost:9876/proofplay/api/v1/multi_location_by_device/${start_date}/${end_date}/${allLocations}/${tenants[0]}/${cookie_token}`, '_blank');
    });
    ...
    return it('sets tenant and downloadCSVForMultipleLocationsSummarized', function () {
      ...
      expect(window.open).toHaveBeenCalledWith(`http://localhost:9876/proofplay/api/v1/multi_location_summarized/${start_date}/${end_date}/${allLocations}/${tenants[0]}/${cookie_token}`, '_blank');
      ...
      it('gets all displays of a tenant', function () {
        ...
        $httpBackend.expectGET(`http://localhost:9876/proofplay/api/v1/retrieve_all_displays/${chosen_tenant}`).respond(to_respond);
      ...
      return it('gets all locations of a tenant', function () {
        ...
        $httpBackend.expectGET(`http://localhost:9876/proofplay/api/v1/retrieve_all_locations/${chosen_tenant}`).respond(to_respond);
