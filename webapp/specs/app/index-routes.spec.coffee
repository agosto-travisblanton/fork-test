...
#
#      spyOn(AuthorizationService, 'authenticated').and.returnValue(true)
#      spyOn(AuthorizationService, 'notAuthenticated').and.returnValue(true)
#      spyOn(AuthorizationService, 'isAdminOrDistributorAdmin').and.returnValue(true)
#      
