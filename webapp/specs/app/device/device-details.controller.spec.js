describe('DeviceDetailsCtrl', function() {
  ...
  describe('.onVolumeChange', function() {
    ...
    it('calls CommandsService.volume with the current device', () => expect(CommandsService.volume).toHaveBeenCalledWith(controller.currentDevice.key, controller.currentDevice.volume));
    ...
    return describe('.onVolumeChangeFailure', function() {
      ...
      return it('logs a detailed error to the console', () => expect($log.error).toHaveBeenCalledWith(`Volume change command error: ${error.status} ${error.statusText}`));
    });
  });
  ...
  describe('.onCustomCommand', function() {
    ...
    it('calls CommandsService.custom with the current device', () => expect(CommandsService.custom).toHaveBeenCalledWith(controller.currentDevice.key, controller.currentDevice.custom));
    ...
    return describe('.onCustomCommandFailure', function() {
      ...
      return it('logs a detailed error to the console', () => expect($log.error).toHaveBeenCalledWith(`Custom command error: ${error.status} ${error.statusText}`));
    });
  });
  ...
  describe('.onResetContent', function() {
    ...
    it('calls CommandsService.contentDelete with the current device', () => expect(CommandsService.contentDelete).toHaveBeenCalledWith(controller.currentDevice.key));
    ...
    return describe('.onResetContentFailure', function() {
      ...
      return it('logs a detailed error to the console', () => expect($log.error).toHaveBeenCalledWith(`Reset content command error: ${error.status} ${error.statusText}`));
    });
  });
  ...
  describe('.onUpdateContent', function() {
    ...
    it('calls CommandsService.contentUpdate with the current device', () => expect(CommandsService.contentUpdate).toHaveBeenCalledWith(controller.currentDevice.key));
  ...
  return describe('isAgostoDomain', function() {
