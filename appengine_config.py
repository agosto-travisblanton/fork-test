...
def _STORAGE_UTILIZATION_THREHSHOLD():
    return 90


app_STORAGE_UTILIZATION_THREHSHOLD = _STORAGE_UTILIZATION_THREHSHOLD()


def _MEMORY_UTILIZATION_THREHSHOLD():
    return 90


app_MEMORY_UTILIZATION_THREHSHOLD = _MEMORY_UTILIZATION_THREHSHOLD()
