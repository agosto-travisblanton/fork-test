...
def _DEVICE_ISSUE_TIMEZONE_OFFSET_CHANGE():
    return 'Timezone offset change'


app_DEVICE_ISSUE_TIMEZONE_OFFSET_CHANGE = _DEVICE_ISSUE_TIMEZONE_OFFSET_CHANGE()
...
def _PLAYER_UPDATE_DEVICE_REPRESENTATION_COMMAND():
    return 'skykit.com/skdchromeapp/update/provisioning'


app_PLAYER_UPDATE_DEVICE_REPRESENTATION_COMMAND = _PLAYER_UPDATE_DEVICE_REPRESENTATION_COMMAND()
